...
// $Id: DcmsRights-all.js 23071 2013-11-08 10:19:38Z spandey $

/*
Generic autocomplete script to be used in conjunction with autocomplete helpers
Sharad 1 Mar 2012: Commented out validation code since we do not need it.
*/
...
//                    prev.valid = true;
        ...
        _selectValue: function (data) {
            ...
            var x = "span[data-ac-msg-for='" + name + "']";
            $(x).html(data.label);

            // Get rid of validation error
            x = "span[data-valmsg-for='" + name + "']";
